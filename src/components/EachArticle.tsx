            ...
            <div className="col-md-6">
                <article className="blog-meta-one mt-35 sm-mt-30 wow fadeInUp" style={{ visibility: 'visible', animationName: "fadeInUp" }}>
                    <div className="post-data">
                        <div className="post-info"><span className="fw-500 text-dark">Rashed Ka -</span> {moment(report.first_publication_date).format('Do MMMM YYYY')}</div>
                        <a href={link} className="mt-15"><h4 className="tran3s blog-title">{report.data.title}</h4></a>
                    </div>
